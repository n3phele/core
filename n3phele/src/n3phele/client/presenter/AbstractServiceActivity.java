...
public abstract class AbstractServiceActivity extends AbstractActivity {
	...
	protected final ServiceListView display;
	...
	public AbstractServiceActivity(String name, ClientFactory factory, ServiceListView activityView, String query) {
		this(name, factory, activityView, false, query);
	}
	
	public AbstractServiceActivity(String name, ClientFactory factory, ServiceListView activityView, boolean countAll,String query) {
		super();
		this.name = name;
