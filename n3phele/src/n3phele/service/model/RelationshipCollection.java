...
public class RelationshipCollection  extends Entity  {
	private long total;
	private List<Relationship> elements;
	/**
	 * 
	 */
	 ...
	 * @param end
	 */
	public RelationshipCollection(Collection<Relationship> pc, int start, int end) {
		super(pc.getName(), pc.getUri(), pc.getOwner(), pc.isPublic());
		this.elements = pc.getElements();
		Collections.sort(this.elements, new Comparator<Relationship>() {
	 ...
	 * @param pc
	 */
	public RelationshipCollection(Collection<Relationship> pc) {
		super(pc.getName(), pc.getUri(), pc.getOwner(), pc.isPublic());
		this.elements = pc.getElements();
	 ...
	 * @return the elements
	 */
	public List<Relationship> getElements() {
		return elements;
	}
	 ...
	 */
	public void setElements(List<Relationship> elements) {
	...
	public String toString() {
		return String.format("RelationshipCollection [total=%s, elements=%s]",
				total, elements);
	}
