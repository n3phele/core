...
public class ServiceCollection  extends Entity  {
	private long total;
	 ...
	 * @param end
	 */
	public ServiceCollection(Collection<Service> pc, int start, int end) {
		super(pc.getName(), pc.getUri(), pc.getOwner(), pc.isPublic());
		this.elements = pc.getElements();
		Collections.sort(this.elements, new Comparator<Service>() {
	 ...
	 * @param pc
	 */
	public ServiceCollection(Collection<Service> pc) {
		super(pc.getName(), pc.getUri(), pc.getOwner(), pc.isPublic());
		this.elements = pc.getElements();
	 ...
	 */
	public void setElements(List<Service> elements) {
	...
	public String toString() {
		return String.format("ServiceCollection [total=%s, elements=%s]",
				total, elements);
	}
