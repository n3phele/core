...
public class Shell/*@bgen(jjtree)*/implements ShellTreeConstants, ShellConstants {/*@bgen(jjtree)*/
  ...
  final public void onexit() throws ParseException {
                 /*@bgen(jjtree) onexit */
  SelfCompilingNode jjtn000 = (SelfCompilingNode)n3phele.service.nShell.ShellNode.jjtCreate(JJTONEXIT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
  ...
  final public void expressionOrNumeric() throws ParseException {
                              /*@bgen(jjtree) expressionOrNumeric */
                               SelfCompilingNode jjtn000 = (SelfCompilingNode)n3phele.service.nShell.ShellNode.jjtCreate(JJTEXPRESSIONORNUMERIC);
                               boolean jjtc000 = true;
                               jjtree.openNodeScope(jjtn000);Token t;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  final public void expressionOrConstant() throws ParseException {
                               /*@bgen(jjtree) expressionOrConstant */
                                SelfCompilingNode jjtn000 = (SelfCompilingNode)n3phele.service.nShell.ShellNode.jjtCreate(JJTEXPRESSIONORCONSTANT);
                                boolean jjtc000 = true;
                                jjtree.openNodeScope(jjtn000);Token t;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1f3c0,0x1f3c0,0xe2c0,0x0,0x300000,0x300000,0x19000000,0x9000000,0x300000,0x300000,0x300000,0xe2c0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x20000000,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x4,0x0,0x0,0x838,0x8,0x0,0x0,0x0,0x8f0,0x830,0x8b0,0x8f0,0x5c0,0x5c0,0xdf0,0xdf0,0x1,0x0,0x4,};
   }
